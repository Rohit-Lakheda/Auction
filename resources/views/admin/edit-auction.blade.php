...
<div class="card">
    ...
    <form method="POST">@csrf
        <div class="form-group"><label>Auction Title *</label><input type="text" name="title" required value="{{ old('title',$auction->title) }}"></div>
        ...
        <div class="form-group"><label>EMD Amount (₹) *</label><input type="number" step="0.01" min="0" name="emd_amount" required value="{{ old('emd_amount', $auction->emd_amount ?? app(\App\Services\AppSettingsService::class)->getFloat('emd_default_amount', (float) config('emd.default_emd_amount', 10000))) }}"></div>
