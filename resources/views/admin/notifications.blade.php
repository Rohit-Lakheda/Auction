...
<div class="card">
    ...
    <form method="POST" action="{{ route('admin.notifications.send') }}" enctype="multipart/form-data" id="composeForm">
        ...
        <div class="form-group">
            ...
            <select name="recipient_filter" id="recipientFilter">
                <option value="manual">Manual Selection</option>
                <option value="all_users">All Users</option>
                <option value="active_bidders">Active Bidders</option>
                <option value="winners">Winners</option>
                <option value="defaulted">Defaulted Users</option>
...
<script>
    ...
    document.getElementById('recipientFilter').addEventListener('change', (e) => {
        ...
        checks.forEach(c => c.disabled = !manual);
        if (!manual) {
            checks.forEach(c => c.checked = false);
            updateSelectedCount();
        }
